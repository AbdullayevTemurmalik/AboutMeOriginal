export const translations = {
  uz: {
    ...
    frontendDesc:
      "React JS, Next JS va Vue JS orqali murakkab interfeyslarni Pixel-Perfect darajasida quraman.",
    backendMastery: "Backend Mastery",
    backendDesc:
      "Node JS, Express va PostgreSQL yordamida Swagger bilan hujjatlashtirilgan xavfsiz API tizimlari.",
    formNameLabel: "Ism",
    formNamePlaceholder: "Ismingizni kiriting",
    formContactLabel: "Email yoki Telegram",
    formContactPlaceholder: "Telegram username ni kiriting",
  ...
  ru: {
    ...
    frontendMastery: "Frontend Mastery",
    frontendDesc:
      "Создаю сложные интерфейсы с React JS, Next JS и Vue JS на уровне Pixel-Perfect.",
    backendMastery: "Backend Mastery",
    backendDesc:
      "Безопасные API-системы, задокументированные с помощью Swagger, с использованием Node JS, Express и PostgreSQL.",
    formNameLabel: "Имя",
    formNamePlaceholder: "Введите ваше имя",
    formContactLabel: "Email или Telegram",
    formContactPlaceholder: "Введите Telegram имя пользователя",
  ...
  en: {
    ...
    frontendMastery: "Frontend Mastery",
    frontendDesc:
      "Building complex interfaces with Pixel-Perfect precision using React JS, Next JS, and Vue JS.",
    backendMastery: "Backend Mastery",
    backendDesc:
      "Secure API systems documented with Swagger using Node JS, Express, and PostgreSQL.",
    formNameLabel: "Name",
    formNamePlaceholder: "Enter your name",
    formContactLabel: "Email or Telegram",
    formContactPlaceholder: "Enter your telegram username",
